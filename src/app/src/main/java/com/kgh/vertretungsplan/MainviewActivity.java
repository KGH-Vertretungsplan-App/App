...
public class MainviewActivity extends Activity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		imageview2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				webview1.loadUrl("https://cloud.0network.de/vertretungsplan");
		...
		button1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				webview1.loadUrl("https://cloud.0network.de/vertretungsplan/subst_001.htm");
				_normalize();
				button1.setBackgroundResource(R.drawable.kreis);
			}
		});
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				webview1.loadUrl("https://cloud.0network.de/vertretungsplan/subst_002.htm");
				_normalize();
				button2.setBackgroundResource(R.drawable.kreis);
			}
		});
		...
		button3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				webview1.loadUrl("https://cloud.0network.de/vertretungsplan/subst_003.htm");
				_normalize();
				button3.setBackgroundResource(R.drawable.kreis);
			}
		});
		...
		button4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				webview1.loadUrl("https://cloud.0network.de/vertretungsplan/subst_004.htm");
				_normalize();
				button4.setBackgroundResource(R.drawable.kreis);
			}
		});
		...
		button5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				webview1.loadUrl("https://cloud.0network.de/vertretungsplan/subst_005.htm");
				_normalize();
				button5.setBackgroundResource(R.drawable.kreis);
			}
		});
	...
	private void initializeLogic() {
		webview1.loadUrl("https://cloud.0network.de/vertretungsplan/subst_001.htm");
		button1.setBackgroundResource(R.drawable.kreis);
		if (Download.getString("dl-20.02.2021", "").equals("")) {
			_webviewDialog("https://kghalle.tk/changelog/latest", "- Neues Update - Changelog", "Okay", false, "#ffffff");
			Download.edit().putString("dl-20.02.2021", "gotya").commit();
		}
	}
